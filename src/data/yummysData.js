export const yummysItems = [
  {
    id: 1,
    name: "Ayamase Rice",
    price: 6500,
    image: "ayamaseRice.jpg", // Just the filename
    description: "Roasted pepper with bleached palm oil...",
    longDescription: "Experience the ultimate comfort food...",
    ingredients: ["Ofada Rice", "Green pepper", "Palm oil"]
  },
   {
      id: 2,
      name: "Spicy Pizza",
      price: 9000,
      image: "Margherita-Pizza-093.webp",
      description: "Loaded with Green pepperoni.",
    ...
    },
    {
      ...
      price: 5000,
      image: "Amala.jpg",
      description: "Amala, ewudu, and gbegiri.",
...
export const yummysUpsells = [
  { id: 101, name: "Chocolate Shake", price: 2500, image: "ChocolateShakeD.webp" },
  { id: 102, name: "Naija Fizz", price: 1200, image: "NaijaFizz.webp" },
  { id: 103, name: "CocaCola", price: 500, image: "CocaCola.webp" },
