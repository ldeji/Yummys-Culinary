...
export default function Menu({ addToCart }) {
 ...
 return (
    <section className="bg-yellow-50 p-10 max-w-6xl mx-auto min-h-screen">
      <h2 className="text-3xl font-bold text-center mb-8 text-yellow-500">Our Full Menu</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {menuItems.map((item) => (
          <div key={item.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:scale-120 transition duration-300">
